...
public class DListTest {
	...
	public void test_remove() {
		...
		assertEquals("[ A  ]", lSingle.toString());
		assertEquals("A", lSingle.remove(0));
		...
		assertEquals("[ B C D E  ]", lMulti.toString());
		lMulti.remove(2);
		assertEquals("[ B C E  ]", lMulti.toString());
	...
	public void test_remove1() {
		...
		assertEquals("[ B C D E  ]", lMulti.toString());
		lMulti.remove1("B");
		assertEquals("[ C D E  ]", lMulti.toString());
		
		lMulti.remove1("C");
		assertEquals("[ D E  ]", lMulti.toString());
		
		lMulti.remove1("E");
		assertEquals("[ D  ]", lMulti.toString());
		
		lMulti.remove1("D");
		assertEquals("[  ]", lMulti.toString());
	}
	@Test
	public void test_removeRange() throws Exception{
		//lEmpty.removeRange(0, 1);
		//assertNotEquals("[  ]", lEmpty.toString());


		//assertEquals("[ A  ]", lSingle.toString());
		//lSingle.removeRange(0, 0);
		//assertEquals("[   ]", lSingle.toString());
		...
		assertEquals("[ B C D E  ]", lMulti.toString());
		lMulti.removeRange(2, 3);
		assertEquals("[ B C  ]", lMulti.toString());
		
		assertEquals("[ B C  ]", lMulti.toString());
		lMulti.removeRange(0, 1);
		assertEquals("[ B C  ]", lMulti.toString());

		lMulti.removeRange(0, 0);
	...
	public void test_addAll() {
		...
		lEmpty.addAll(0, Arrays.asList("A"));
		assertEquals("[ A  ]", lEmpty.toString());

		assertEquals("[ A  ]", lSingle.toString());
		lSingle.addAll(0, Arrays.asList("A"));
		assertEquals("[ A A  ]", lSingle.toString());
		...
		assertEquals("[ B C D E  ]", lMulti.toString());
		lMulti.addAll(0, Arrays.asList("A"));
		assertEquals("[ A B C D E  ]", lMulti.toString());
		
		lMulti.addAll(5, Arrays.asList("F G"));
		assertEquals("[ A B C D E F G  ]", lMulti.toString());
