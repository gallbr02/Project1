...
public class KuhnTrainer {
	...
	class Node {
		...
		public String toString() {
			double[] strategy = getAverageStrategy();
			return String.format("%8s:\t%.3f\t%.3f", infoSet, strategy[PASS], strategy[BET]);
		}
	}
	...
	public void train(int iterations) {
		...
		System.out.println("Average Kuhn Poker game value for player 1: " + util / iterations);
		System.out.println("Note: Each information set consists of the card dealt to a player");
		System.out.println("      plus the action history abbreviated as follows:");
		System.out.println("\tp = pass/check/fold, i.e. add nothing to the pot");
		System.out.println("\tb = bet/raise/call, i.e. add 1 to the pot");
		System.out.println("info set:\t[p]ass\t[b]et");
