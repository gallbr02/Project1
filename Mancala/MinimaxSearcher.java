/**
 * MinimaxSearcher.java - a depthRemaining-limited minimax searcher
...
public class MinimaxSearcher implements GameTreeSearcher {
	/**
	 * variable <code>depthLimit</code> - the depthRemaining limit of
	 * minimax search */
	 ...
	 * most recently evaluated node according to depthRemaining-limited
	 ...
	 * the given depthRemaining limit.
	 *
	 * @param depthLimit an <code>int</code> value - the depthRemaining of
	...
	/**
	 * <code>eval</code> - return the depthRemaining-limited minimax value
	 * of the given node
	 *
	 * @param node a <code>GameNode</code> value
	 * @return a <code>double</code> value - depthRemaining-limited
	 * minimax value */
	...
	public double minimaxEval(GameNode node, int depthLeft) {
		...
		// Return utility if game over or depthRemaining limit reached
		...
		// Evaluate the depthRemaining-limited minimax value for each
